...
export const generateReinjectGrammar = () => ({
  fileTypes: [],
...
export const REINJECT_GRAMMAR_SCOPE_NAME =
  'inline.tagged-template-languages.reinjection'
export const REINJECT_GRAMMAR_PATH = './dist/reinject-grammar.json'

export const generateBasicGrammar = () => ({
  fileTypes: [],
  injectionSelector: pipe(
    targetScopes,
